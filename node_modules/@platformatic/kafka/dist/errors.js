...
export class ProtocolError extends GenericError {
    ...
    constructor(codeOrId, serverErrorMessage = null, properties = {}, response = undefined) {
...
export class ResponseError extends MultipleErrors {
    ...
    constructor(apiName, apiVersion, errors, response, properties = {}) {
        super(`Received response with error while executing API ${protocolAPIsById[apiName]}(v${apiVersion})`, Object.entries(errors).map(([path, [errorCode, detailedErrorMessage]]) => new ProtocolError(errorCode, detailedErrorMessage, { path }, response)), {
            ...properties,
            response
        });
