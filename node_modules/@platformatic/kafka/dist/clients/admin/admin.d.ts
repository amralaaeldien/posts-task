...
import { type DescribeAclsResponseResource } from '../../apis/admin/describe-acls-v3.ts';
...
export declare class Admin extends Base<AdminOptions> {
    ...
    listConsumerGroupOffsets(options: ListConsumerGroupOffsetsOptions, callback: CallbackWithPromise<ListConsumerGroupOffsetsGroup[]>): void;
    ...
    deleteConsumerGroupOffsets(options: DeleteConsumerGroupOffsetsOptions, callback: CallbackWithPromise<{
        name: string;
        partitionIndexes: number[];
    }[]>): void;
    deleteConsumerGroupOffsets(options: DeleteConsumerGroupOffsetsOptions): Promise<{
        name: string;
        partitionIndexes: number[];
    }[]>;
